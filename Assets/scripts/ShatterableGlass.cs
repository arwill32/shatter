...
public class ShatterableGlass : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        location = Player.GetComponent<Transform>().position;
        direction = Player.GetComponent<Transform>().forward;
    ...
    {
        Debug.Log(location);
        ShatterableGlassInfo Inf = new ShatterableGlassInfo(location, direction);
        Shatter3D(Inf);
        //spawner.gone();
        //spawner.Spawn();
